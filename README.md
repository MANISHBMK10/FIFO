...
# Simulation Results
Asynchronous FIFO Testbench results -
C:\iverilog\bin>iverilog -o a tb_fifo.v top_fifo.v sync_w2r.v sync_r2w.v rempty.v wfull.v fifo_mem.v

C:\iverilog\bin>vvp a
